...
/**
 * Strings for component 'enrol_ilbeadtutorado', language 'en'.
 *
...
$string['newenrols_desc'] = 'Allow users to self enrol into new ilb ead courses by default.';
...
$string['pluginname'] = 'Tutored ILB/EAD self enrolment';
$string['pluginname_desc'] = 'The tutored ilbead enrolment plugin allows users to choose which courses they want to participate in. The courses may be protected by an enrolment key. Internally the enrolment is done via the manual enrolment plugin which has to be enabled in the same course.';
$string['requirepassword'] = 'Require enrolment key';
$string['requirepassword_desc'] = 'Require enrolment key in new courses and prevent removing of enrolment key from existing courses.';
$string['role'] = 'Default assigned role';
$string['ilbeadtutorado:config'] = 'Configure ILB EAD self enrol instances';
$string['ilbeadtutorado:manage'] = 'Manage enrolled users';
$string['ilbeadtutorado:unenrol'] = 'Unenrol users from course';
$string['ilbeadtutorado:unenrolilbeadtutorado'] = 'Unenrol self from the course';
...
$string['status_desc'] = 'Enable ilb ead self enrolment method in new courses.';
$string['status_help'] = 'If disabled all existing self enrolments are suspended and new users can not enrol.';
$string['unenrol'] = 'Unenrol user';
$string['unenrolilbeadtutoradoconfirm'] = 'Do you really want to unenrol yourself from course "{$a}"?';
