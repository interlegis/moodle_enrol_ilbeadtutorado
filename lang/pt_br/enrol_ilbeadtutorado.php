...
$string['pluginname'] = 'Inscrição EAD tutorado do ILB';
$string['pluginname_desc'] = 'O plugin de inscrição EAD tutorado do ILB permite que usuários escolham quais cursos de EAD desejam participar, restringindo o número de cursos simultâneos e definindo punições por abandono ou reprovação. Internamente, a inscrição é realizada pelo plugin de inscrições manuais, que deve estar habilitado no curso.';
...
$string['ilbeadtutorado:config'] = 'Configurar instâncias de Inscrição EAD do ILB';
$string['ilbeadtutorado:manage'] = 'Gerenciar usuários inscritos';
$string['ilbeadtutorado:unenrol'] = 'Desinscrever usuários do curso';
$string['ilbeadtutorado:unenrolilbeadtutorado'] = 'Desinscrever-se do curso';
...
$string['unenrolilbeadtutoradoconfirm'] = 'Você realmente deseja desinscrever-se do curso "{$a}"?';
